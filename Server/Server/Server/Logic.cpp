...
void init(vector<SCHOOL>& schools)
{
	...
	TEAM te1 = { 0, "Chupacabras","example description lorem eipsum take up space",{0,0,0},,{{0, "GG@abv.bg", 1},{0, "SBP@abv.bg", 2}} };
	TEAM te2 = { 1, "Anti-Chupacabras","example description lorem eipsum take up space",{0,0,0},,{{1, "IUM@abv.bg", 1},{1, "SBP@abv.bg", 2}} };
	TEAM te3 = { 2, "We exist too","example description lorem eipsum take up space",{0,0,0},,{{2, "III@abv.bg", 1},{2, "MMM@abv.bg", 2}} };
